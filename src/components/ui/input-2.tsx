...
import { hasNestedElementOfType } from '@/utils/hasNestedElementOfType';
...
const useInputContext = () => {
  ...
  if (!context) {
    throw new Error(
      'Input2 compound components must be used within an Input2.Root component',
    );
  }
  return context;
};
...
const Input2 = InputComponent as InputType;
...
Input2.Group = InputGroup;
Input2.Label = InputLabel;
Input2.LeftIcon = InputLeftIcon;
Input2.RightIcon = InputRightIcon;
Input2.PasswordToggle = InputPasswordToggle;
Input2.ClearButton = InputClearButton;
